import '../modules/view screens/cart screen/controller/cart_screen_controller.dart';
...
class SnackToast {
  ...
  static showDeleteDialog(id) {
    Get.defaultDialog(
      ...
      confirmTextColor:
          Colors.white, // Change the color for the "Delete" button
      cancelTextColor: Colors.blue, // Change the color for the "Cancel" button
      onConfirm: () async {
